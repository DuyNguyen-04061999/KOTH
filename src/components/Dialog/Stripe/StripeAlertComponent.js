    ...
    return (
        <Dialog open={isAlertDialog} onClose={() => {
            ...
            <Box component={"div"} className='position-relative rounded p-3' sx={{
                ...
                <Box component={"div"} className='text-center mt-4' sx={{
                    ...
                    <span className='' style={{
                        ...
                        typeAlert && typeAlert === "success" ? "Payment Success" : "Payment Error"
                    }</span>
                </Box>
                <Box component={"div"} className='d-flex justify-content-center align-items-center text-center mt-3 mb-2' sx={{
                    color: '#404040',
                    fontSize: '14px'
                }}>After a successful payment, the customer return to your websites.</Box>
            </Box>
        </Dialog>
    )
}
