...
import { getCheckOut } from "../../../redux-saga-middleware/reducers/checkouReducer";
import { buyPackage } from "../../../redux-saga-middleware/reducers/packageReducer";
import {
  closeCheckWallet,
  toggleCheckWallet,
        ...
        >
          ...
          >
            ...
            >
              ...
              {typeWallet === "combo1" || typeWallet === "combo2" ? (
                <Typography sx={{ color: "#BF48ED", fontSize: "18px" }}>
                  {" "}
                  {feeCheckout
                    ? Number(sl * goldCombo + feeMoney).toFixed(2)
                    : 0}
                </Typography>
              ) : (
                <Typography sx={{ color: "#BF48ED", fontSize: "18px" }}>
