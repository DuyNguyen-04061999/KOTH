...
import { closeShareDialog } from "../../../redux-saga-middleware/reducers/referralReducer";
...
export default function ReferralShare() {
  const { isOpenShareDialog } = useSelector((state) => state.referralReducer);
  const { width, height } = useWindowDimensions();
  const dispatch = useDispatch();
  const copyref = "https://play4promo.com/";
  return (
    <Dialog
      sx={{
        "& .MuiDialog-paper": {
