...
export default function ChatWorldList() {
    ...
    const {chatWorld, friendList, chatPopup} = useSelector((state) => state.chatReducer);
    ...
    const renderChat = isFetching ? (<UserChatLoadingList/>) : (worldMessage
        ...
        .map((e, index) => {
            ...
            >
                {e?.messageFromName === userName && token ? (<>
                    {e?.messageGameId > 0 && e?.messageRoomName ? (<Box
                    ...
                    >
                        ...
                        >
                            ...
                            <Box
                                ...
                                sx={{
                                    backgroundColor: "#3e2a52", borderRadius: "5px",
                                }}
                            >
                                <Box
                                    sx={{
                                ...
                                >
                                    <img
                                        src={e && e?.messageGameAvatar && e?.messageGameAvatar !== "normal" ? process.env.REACT_APP_SOCKET_SERVER + "/" + e?.messageGameAvatar : images.Aa}
                                        alt="..."
                                        width={"100%"}
                                        height={"75px"}
                                        style={{
                          ...
                          <span
                              style={{
                                  color: "white", fontWeight: "500 !important",
                              }}
                          >
                            ...
                            Price: {e?.messageBetPrice}
                                    ...
                                    <Box
                                        onClick={() => handleOnClickInviteGameMess(e.messageGameId, e.messageRoomId)}
                    ...
                    >
                        ...
                        <span
                            style={{
                                color: "white", fontSize: "10px", fontWeight: "500 !important", letterSpacing: "0.5px",
                            }}
                        >
                    ...
                    <Box className="pt-2">
                        <Avatar
                            ...
                            src={e?.messageFromAvatar ? process.env.REACT_APP_SOCKET_SERVER + "/" + e?.messageFromAvatar : images.undefinedAvatar}
                    ...
                    <span
                        style={{
                            color: "#7C81F2", borderRadius: "5px", fontWeight: "500 !important",
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Box
                                        sx={{
                                            width: "fit-content", color: "#7878a7", fontSize: "14px",
                                        }}
                                    >
                            <span
                    ...
                    <Box> <span style={{ color: "white", marginLeft: "15px", fontSize: "10px", fontWeight: "500 !important", letterSpacing: "0.5px", }} > {e?.updatedAt && moment(e?.updatedAt).format("H:mm a")} </span> </Box>
                </Box>)}
            </Box>);
        }));
    ...
    >
        ...
        >
            ...
            {token && (checkExistInFriendList() === true ? (<MenuItem
                sx={{
                    padding: "5px",
                }}
            >
            ...
            >
                <Box
                    ...
                    className="p-1 text-white"
                    sx={{
                        background: "linear-gradient(180deg, #843ff0, #7748ed)", width: "100%", borderRadius: "4px",
                    }}
                >
