            ...
            <Box component={"div"} className='p-2 ps-4 pe-4'>
                ...
                <Box component={"div"} className='rounded p-3' sx={{
                    ...
                    <Box component={"div"} className='d-flex justify-content-between' sx={{
                        ...
                        <Box component={"div"}>
                            ...
                            <Typography sx={{
                                ...
                                fontWeight: 600,
                                lineHeight: "16px",
                            }}>2022-07-23 17:36:50</Typography>
                        </Box>
                        <Box component={"div"}>
                            <Typography sx={{
                                color: " #808191",
                    ...
                    <Box component={"div"} className='text-center p-2 text-white' sx={{
                        marginTop: "14px",
                        borderRadius: "16px", background: "#355DFF"
                    }}>
                        <Typography sx={{
                            color: "#FFF",
                            textAlign: "center",
                    ...
                    <Box component={"div"} className='text-center p-2 text-white' sx={{
                        marginTop: "14px",
                        borderRadius: "16px", background: "#FF4135"
                    }}>
                        <Typography sx={{
                            color: "#FFF",
                            textAlign: "center",
