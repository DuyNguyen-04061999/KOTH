...
export default function PlayGame(props) {
  ...
  console.log("orientation,device: ", orientation, device);
  useEffect(() => {
    if (
      startGame &&
      ((width < 576 &&
      ...
      >
        ...
        >
          {detailTournament &&
            ...
            detailTournament?.tournamentInfors?.game?.GameFiles.length >= 4 && (
              <FullScreen
                className={`${deviceType === "iOS" ? "fullscreen_IOS" : ""}`}
                handle={screen}
              ...
              >
                ...
                <Fragment>
                  <UnityGameComponent
                    ...
                    skinId={detailTournament?.tournamentInfors?.skin?.id || ""}
                    type="tournament"
