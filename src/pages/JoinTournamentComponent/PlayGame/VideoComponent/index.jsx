    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <source
                        src={detailTournament?.tournamentVideo
                    ...
                    detailTournament?.advertisingLink && (
                        ...
                        >
                            ...
                            >
                                <Box
                                    component={"img"}
                                    src={detailTournament?.advertisingThumbnail ? "https://storage.googleapis.com/web-system-files/" + detailTournament?.advertisingThumbnail : imageDesktop.LogoCongTy}
                                    sx={{
                                        maxWidth: "76px",
                                        maxHeight: "76px",
                                        width: "76px",
                                ...
                                <Box sx={{
                                    ...
                                    >
                                        {
                                            detailTournament?.advertisingName ? detailTournament?.advertisingName : "Play4promo"
                                        }
                                    </Typography>
                                    <Typography className="text-white" sx={{
                                        ...
                                        {
                                            detailTournament?.advertisingLink ? detailTournament?.advertisingLink : "Brand Name"
                                        }
                                    </Typography>
                                </Box>
                                <Box
