          ...
          {games && games?.length > 0 && games.map((game, i_game) => (
            <Grid item xs={2} key={i_game} sx={{
              ...
              <Card className='rounded bg-info position-relative'>
                  <img
                    src={process.env.REACT_APP_SOCKET_SERVER + '/' + game?.gameAvatar}
                    alt=""
                    className='img-fluid'
                    width={'100%'}
                    onClick={() => {
                  ...
                  />
                  <Typography className='position-absolute text-white text-bold text-center' sx={{
                    bottom: 0,
                    left: 0,
                    width: '100%',
                  ...
                  <Box className="position-absolute ps-1 pe-1 text-white" sx={{
                    top: 0,
                    right: 0,
                    background: '#fc3c3c'
                  }} onClick={() => {
                  ...
                  <Box className="position-absolute ps-1 pe-1 text-white bg-success" sx={{
                    top: 0,
                    left: 0,
                  }} onClick={() => {
                      handleEditGame(game)
